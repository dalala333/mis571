...
public class QueryActivity extends Activity implements View.OnClickListener {
    ...
    private Button backBtn, resultBtn, showlistBtn;
    private Spinner querySpinner;
    private ScrollView scrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn = findViewById(R.id.goback_btn);
        resultBtn = findViewById(R.id.showresult_btn);
        showlistBtn = findViewById(R.id.showcheckoutlist_btn); // Added button for showing checkout list
        querySpinner = findViewById(R.id.querylist_spinner);
        scrollView = findViewById(R.id.scrollview_queryresults);
        ...
        backBtn.setOnClickListener(this);
        resultBtn.setOnClickListener(this);
        showlistBtn.setOnClickListener(this); // Set listener for the new button
    }
    ...
    private void handleShowCheckoutList() {
        // SQL query for the checkout list
        String sql = SQLCommand.CHECKOUT_LIST;

        // Start ShowListActivity with the SQL query
